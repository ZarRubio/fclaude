...
const COPY = {
  es: {
    ...
    text: 'Una seleccion de los productos mas pedidos. Detecta rapido lo que necesitas y consultalo por WhatsApp al instante.',
    catalogButton: 'Ver catalogo completo',
    askAvailability: 'Consultar precio y stock',
    prevLabel: 'Producto anterior',
    nextLabel: 'Producto siguiente',
    waCatalog: 'Hola, quiero recibir el catalogo completo de SAHM con precios y disponibilidad',
    waProduct: 'Hola, quiero consultar precio y disponibilidad del producto',
    stockLabel: 'En stock',
    comingSoonTitle: 'Catalogo proximamente',
    comingSoonMessage: 'Estamos subiendo el catalogo completo. Estara disponible muy pronto.',
    ...
    items: [
      {
        ...
        tag: 'Mas pedida',
        stock: true,
        description: 'Medida estandar para Honda Wave, Bajaj CT100 y similares. Alto agarre para ciudad y carretera.',
      ...
      {
        id: 3,
        nombre: 'Camara reforzada 2.75-17',
        codigo: 'CM-275-17',
        tag: 'Durable',
        stock: true,
        description: 'Camara con caucho grueso para mayor durabilidad y menos pinchazos. Ideal para taller.',
        image: 'https://images.unsplash.com/photo-1609630875171-b1321377ee65?auto=format&fit=crop&w=900&q=80',
      },
      {
        id: 4,
      ...
      },
      {
        ...
        tag: 'Rendimiento',
        stock: true,
        description: 'Filtro de espuma para mantenimiento periodico. Mejora respuesta del motor y reduce consumo.',
      ...
      },
      {
        ...
        tag: 'Mantenimiento',
        stock: true,
        description: 'Lubricante para servicio periodico. Protege el motor en ciudad y ruta. Recomendado para flotas.',
