...
const COPY = {
  es: {
    ...
    items: [
      ...
      {
        nombre: 'TRANSMISION',
        descripcion: 'Cadenas, coronas y pinones para mantener potencia y respuesta en ruta urbana y reparto.',
        waMessage: 'Hola, necesito repuestos de transmision para mi moto. Mi modelo es: ',
      ...
      {
        nombre: 'ELECTRICO',
        descripcion: 'Baterias, focos, bobinas y componentes para mantener arranque confiable y sistema estable.',
        waMessage: 'Hola, necesito repuestos electricos para mi moto. Mi modelo es: ',
      ...
      {
        nombre: 'SUSPENSION',
        descripcion: 'Amortiguadores y componentes de suspension para mejorar confort, control y seguridad.',
        waMessage: 'Hola, necesito repuestos de suspension para mi moto. Mi modelo es: ',
      ...
      },
      {
        ...
        highlights: ['Uso diario', 'Montaje rapido', 'Stock frecuente'],
      },
    ],
  },
  en: {
